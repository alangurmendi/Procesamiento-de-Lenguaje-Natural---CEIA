...
A lo largo de estos trabajos se exploraron métodos clásicos de representación, modelos probabilísticos, embeddings, modelos basados en redes neuronales recurrentes y sistemas seq2seq para traducción automática.
El foco estuvo siempre en experimentar, interpretar resultados, comparar estrategias y entender las limitaciones reales de cada enfoque.
